<template>
    <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="cnt" style="">
                    <div style="background-color: #FFF9F4" class="textD">
                        ...
                        <div>
                            <p style="color: #92959E" class="numbertxt2">Request</p>
                            <h6 style="color: #15192C" class="numbertxt">{{ request }}</h6>
                        </div>
                    </div>
                    <div style="background-color: #ECFFF4" class="textD">
                        <div style="" class="icdiv">
                            <span style="font-size: 3rem; color: #00672D"><i class="fas fa-users"></i></span>
                        </div>
                        <div>
                            <p style="color: #92959E" class="numbertxt2">Users</p>
                            <h6 style="color: #15192C" class="numbertxt">{{ users }}</h6>
                        </div>
                    </div>
                    <div style="background-color:#F9FBFF" class="textD">
                        <div style="" class="icdiv">
                            <span style="font-size: 3rem; color: #005BFF"><i class="fas fa-biking"></i></span>
                        </div>
                        <div>
                            <p style="color: #92959E" class="numbertxt2">Riders</p>
                            <h6 style="color: #15192C" class="numbertxt">{{ riders }}</h6>
                        </div>
                    </div>
                    <div style="background-color: #D2E2FF" class="textD">
                        <div style="" class="icdiv">
                            <span style="font-size: 3rem; color: #92959E"><i class="fab fa-red-river"></i></span>
                        </div>
                        <div>
                            <p style="color: #92959E" class="numbertxt2">Completed</p>
                            <h6 style="color: #15192C" class="numbertxt">{{ competedR }}</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="mt-10 col-lg-8">
                <div class="tabTitle">
                    <h4 class="ml-4">All Request</h4>
                    <v-data-table :headers="headers" :items="desserts" :search="search" sort-by="calories"
                        :items-per-page="3" class="">
                        <template v-slot:top>
                            <v-toolbar flat>
            ...
            <div class="mt-10 col-lg-4">
                <div class="reviews">
                    <h4>Our Riders</h4>
                    <div class="contDi">
                        <div v-for="riders in ridersDetails" :key="riders.id" class="riderReview">
                            <v-avatar :size="avata">
                                <img :src=riders.img>
                            </v-avatar>
                            <div class="nameTxt">
                                <h4>{{ riders.firstName }}</h4>
                                <p>Lugbe</p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- <div class="row mt-10"> -->
            <!-- <div class="col-lg-12">
                <div class="elevation-4 pa-4 chartD">
                    <div id="chart">
            ...
            <!-- <div class="col-lg-6">
                <div class="elevation-4 pa-4 mainChat">
                    <h5>Live Chat</h5>
                    <div class="chatD">
                        <div id="chatId" v-for="message in messages" :key="message.id" class="adminChat">
                            <v-avatar size="62">
                                <img src="https://cdn.vuetifyjs.com/images/john.jpg" alt="John">
                            </v-avatar>
                            <div class="caretTxt">
                                <span><i class="fas fa-2x fa-caret-left"></i></span>
                                <div class="textCnt">
                                    <p>{{message.text}}</p>
                                </div>
                            </div>
                        </div>
                        <div v-if="recieved" class="userChat">
                            <div class="caretTxt">
                                <span><i class="fas fa-2x fa-caret-right"></i></span>
                                <div v-for="message in messages" :key="message.id" class="textCnt">
                                    <p>{{message.text}}</p>
                                </div>
                            </div>
                            <v-avatar size="62">
                    ...
                    <textarea class="textAre form-control" v-model="mesg" rows="2"
...
export default {
    ...
    async mounted() {
        ...
        await axios.all([
            axios.get('http://localhost:3000/api/v1/jwtauth/request/admin/requests', {
                headers: {
                    'token': `Bearer ${token}`
                }
            }),
            ...
            .then(axios.spread((response1, response2, response3, response4) => {
                ...
                response1.data.data.adminrequests.forEach(elem => {
                    this.desserts.push({
