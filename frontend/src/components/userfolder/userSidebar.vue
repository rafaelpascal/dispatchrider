<template>
    <div style="display: flex; justify-content: space-between">
        <b-sidebar  width="18%" id="sidebar-footer" aria-label="Sidebar with custom footer" no-header shadow>
                    ...
                    <div style="margin: 2rem 0; display: flex; flex-direction:column; align-items:flex-start">
                        <div class="dropdown">
                            ...
                            <ul style="border-radius:0%; border:none; padding:0%" class="dropdown-menu">
                                <li>
                                    <router-link class="dropdown-item" to="/userDashboard">Dashboard</router-link>
                                </li>
                                <li>
                        ...
                        <router-link class="sideBtn" to="/usernewReuest">New Request</router-link>
                        <router-link class="sideBtn" to="/contactUs">Contact us</router-link>
                    </div>
                </div>
        ...
        <nav :class="{ 'onScroll': !view.topOfPage}" id="navigation">
            <button id="bar" style="margin: 0 2rem; background-color: transparent;" v-b-toggle.sidebar-footer><span
                    style="font-size: 20px"><i class="fas fa-bars"></i></span></button>
            <div style="width:100%">
                <ul class="links">
                    <li class="mr-8">
                        <v-avatar>
