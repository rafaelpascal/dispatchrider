                        ...
                        <div class="formDiv">
                            ...
                            <div class="inputs">
                                <div class="">
                                    ...
                                    <v-text-field solo v-model="email" :rules="[emailrules.required, emailrules.email]"
                                        label="Email Address">
                                    </v-text-field>
    ...
    methods: {
        ...
        async login() {
            if (!this.email || !this.password) {
                ...
                await axios.post('http://localhost:3000/api/v1/jwtauth/auth/login', logindata)
                    .then(response => {
                        ...
                        if (decoded.isAdmin === true) {
                            setTimeout(() => {
                                this.$router.push('/insideDashboard')
                            }, 1200);
                        } else {
                            setTimeout(() => {
